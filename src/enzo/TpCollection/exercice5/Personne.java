...
public class Personne implements Comparable<Personne>{
	...
	public Personne(Personne p){
		this(p.getNom(), p.getPrenom(), p.getDateNaissance(), p.getAdresse());
	}
	/**
	 * Accesseur
	...
	*/
	...
	public int compareTo(Personne p1){
		if(p1.nom.toLowerCase().compareTo(this.nom.toLowerCase())==0){
			return (p1.prenom.toLowerCase().compareTo(this.prenom.toLowerCase()));
		}
		else{return (p1.nom.toLowerCase().compareTo(this.nom.toLowerCase()));}
	}
}
